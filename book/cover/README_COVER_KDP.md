# Amazon KDP Cover Design Specification & Book Blurb
## *The Conative-Integrative Framework (CIF)*
**Author:** Thomas Riebl  
**Trim Size:** $6 \times 9\text{ inches}$ ($152.4 \times 228.6\text{ mm}$)  
**Target Platform:** Amazon Kindle Direct Publishing (Paperback, Hardcover & Kindle eBook)

---

## 1. Back Cover Blurb (Klappentext - English)

> **For centuries, science has struggled with the "Hard Problem of Consciousness": How can subjective, qualitative experience ever emerge from cold, inanimate matter?**
>
...
## 2. Author Biography (About the Author)

### Compact Version (for Back Cover Box — 108 Words)
> **About the Author**  
> **Thomas Riebl** (born 1960 in Western Germany, living in Luxembourg) spent over three decades in enterprise information technology as an independent senior IT consultant and IT manager at a leading global bank. Since 2019, he has dedicated himself to theoretical neuroscience, cybernetics, and philosophy of mind, mastering advanced Bayesian statistics, probability theory, and information theory through rigorous autodidactic self-study. He is the originator of *The Conative-Integrative Framework (CIF)*, the formulation of the *6th Axiom of Consciousness*, and the *Theorem of Minimum Temporal Depth*, uniting the mathematical rigor of complex systems with the profound depth of subjective interiority.

### Extended Version (for Amazon Author Central & Colophon — 215 Words)
> **About the Author**  
...
## 3. Metadata for Amazon KDP Dashboard

* **Book Title:** *The Conative-Integrative Framework*
* **Subtitle:** *Active Inference, Integrated Information, and the Autopoietic Arrow of Mind*
* **Primary Category:** Science & Mathematics / Cognitive Science / Neuroscience
* **Secondary Categories:** 
  1. Philosophy / Mind & Body
  2. Computers & Technology / Artificial Intelligence & Machine Learning
* **Keywords:** *Active Inference, Karl Friston, Free Energy Principle, Integrated Information Theory, Giulio Tononi, Consciousness, Bernardo Kastrup, Analytic Idealism, 6th Axiom, Thomas Riebl, Temporal Depth, Computational Neuroscience, Philosophy of Mind, Thomas Metzinger*
* **Language:** English
